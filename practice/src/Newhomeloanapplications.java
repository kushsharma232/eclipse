...
public class NewHomeloanhomeapplication
{
    ...
    public static void main(final String[] args) throws InterruptedException {
       ...
       // WebDriverWait wait=new WebDriverWait(driver, 20);
        ...
        driver.findElement(By.xpath("//input[@id='emailOrMobile']")).sendKeys(new CharSequence[] { "kushsharma232@gmail.com" });
        button.click();
        driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys(new CharSequence[] { "abcd@1234" });
        loginbutton.click();
        ...
        driver.findElement(By.xpath("//*[@id=\"formSections\"]/div[12]/div/div[12]/a[2]")).click();
        //1st Co-Applicant Profile form page
        ...
        driver.findElement(By.xpath("//*[@id=\"formSections\"]/div[12]/div/div[12]/a[2]")).click();
        //1st Co-Applicant Income form page
